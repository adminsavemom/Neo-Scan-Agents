...
class LitertTesterPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('LiteRT LM Tester'),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            // ── Model Status ───────────────────────────────────────────────
            _sectionTitle('LiteRT Model Status'),
            ...
            const SizedBox(height: 8),
            _filePicker(
              label: 'Select LiteRT Model File',
              hint: '.litertlm  ·  .task  ·  .bin',
